...
export default class CourseVideo extends Vue {
  ...
  private video = this.$refs['video-file']
  private image = this.$refs['image-file']
    ...
    return (
      <div class="course-video">
        ...
        <el-form label-width="70px">
          ...
          <el-form-item>
            <el-button type="primary" onClick={this.handleUpload}>
              开始上传
            </el-button>
            <el-button onClick={() => this.$router.back()}>返回</el-button>
          </el-form-item>
          <el-form-item>
            <p>视频上传中：{this.uploadPercent}%</p>
            {this.isUploadSuccess && (
              <p>
                视频转码中：
                {this.isTransCodeSuccess ? '完成' : '正在处理，请稍后'}
              </p>
            )}
          </el-form-item>
        </el-form>
